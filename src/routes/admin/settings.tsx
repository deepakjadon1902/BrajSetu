...
function Field({
  ...
  return (
    <label className="block">
      <span className="text-xs font-semibold tracking-wide text-navy uppercase">{label}</span>
          ...
          <form onSubmit={onSubmit} className="grid gap-6">
            ...
            >
              <div className="sm:col-span-2">
                <Field
                  label="Meta title"
                  hint={`${form.metaTitle.length} characters — aim for under 60.`}
                >
                  <input
                    className={inputClass}
            ...
            >
              ...
              <div className="sm:col-span-2">
                ...
                >
                  <OgImageUploader value={form.ogImage} onChange={(next) => set("ogImage", next)} />
                </Field>
              </div>
