...
export const properties: Property[] = [
  ...
  {
    id: "pv-004",
    title: "Govardhan Farm House",
    category: "Farm House",
    intent: "Sale",
    price: 26400000,
    location: { city: "Govardhan", locality: "Radha Kund Road" },
  ...
  {
    id: "pv-005",
    title: "Barsana Residential Plot",
    category: "Plot",
    intent: "Sale",
    price: 7200000,
    location: { city: "Barsana", locality: "Rangeeli Mahal Road" },
    specs: { area: 4800 },
    images: [prop4],
    amenities: ["Garden"],
    status: "Price Drop",
  ...
  {
    id: "pv-006",
    title: "Chhatikara Family Apartment",
    category: "Flat",
    intent: "Rent",
    price: 68000,
  ...
  {
    id: "pv-007",
    title: "Ral Village Family House",
    category: "House",
    intent: "Rent",
    price: 125000,
    location: { city: "Ral", locality: "Mathura-Vrindavan Road" },
  ...
  {
    id: "pv-008",
    title: "Jachonda Corner Shop",
    category: "Shop",
    intent: "Sale",
    price: 11250000,
    location: { city: "Jachonda", locality: "Main Road" },
  ...
  {
    id: "pv-009",
    title: "Basonti Farm Retreat",
    category: "Farm House",
    intent: "Rent",
    price: 210000,
    location: { city: "Basonti", locality: "Village Belt" },
  ...
  {
    id: "pv-010",
    title: "Mathura Riverside Penthouse",
    category: "Flat",
    intent: "Sale",
    price: 34500000,
    location: { city: "Mathura", locality: "Yamuna Kinara" },
  ...
  {
    id: "pv-011",
    title: "Khamini Field Plot",
    category: "Plot",
    intent: "Sale",
    price: 4300000,
    location: { city: "Khamini", locality: "Govardhan Link Road" },
    specs: { area: 3200 },
    images: [prop4],
    amenities: [],
    status: "Active",
  ...
  {
    id: "pv-012",
    title: "Goverdhan Link Row House",
    category: "House",
    intent: "Sale",
    price: 14200000,
    location: { city: "Govardhan", locality: "Deeg Road" },
  ...
  {
    id: "pv-013",
    title: "Vrindavan Studio Flat",
    category: "Flat",
    intent: "Rent",
    price: 32000,
    location: { city: "Vrindavan", locality: "Sunrakh Road" },
  ...
  {
    id: "pv-014",
    title: "Barsana Courtyard House",
    category: "House",
    intent: "Sale",
    price: 21800000,
    location: { city: "Barsana", locality: "Ladli Ji Temple Road" },
  ...
  {
    id: "pv-015",
    title: "Chhatikara Corner Shop",
    category: "Shop",
    intent: "Rent",
    price: 88000,
    location: { city: "Chhatikara", locality: "Vrindavan Entry Road" },
  ...
  {
    id: "pv-016",
    title: "Aading Residential Plot",
    category: "Plot",
    intent: "Sale",
    price: 9600000,
    location: { city: "Aading", locality: "Govardhan Parikrama Belt" },
    specs: { area: 5400 },
    images: [prop4],
    amenities: ["Garden"],
    status: "New",
  ...
  {
    id: "pv-017",
    title: "Mathura Garden Flat",
    category: "Flat",
    intent: "Sale",
    price: 12400000,
    location: { city: "Mathura", locality: "Janmabhoomi Link Road" },
  ...
  {
    id: "pv-018",
    title: "Jachonda Orchard Farm House",
    category: "Farm House",
    intent: "Sale",
    price: 19900000,
    location: { city: "Jachonda", locality: "Khamini Road" },
...
export const newsArticles: NewsArticle[] = [
  {
    id: "n1",
    title: "Where Braj Mandal buyer demand is shifting this quarter",
    excerpt:
      "Vrindavan link roads and Govardhan village belts are seeing stronger enquiry quality.",
    date: "12 July 2026",
    image: news1,
  },
  {
  ...
  {
    id: "n4",
    title: "Renting out a Braj Mandal second home without the friction",
    excerpt:
      "How owners near Vrindavan and Mathura are structuring longer leases with better tenant quality.",
    date: "18 June 2026",
    image: news1,
  },
];
